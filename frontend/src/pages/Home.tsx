      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-6">
        <div className="w-full max-w-md">
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20">
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full py-4 bg-gray-700 to-gray-600 text-white font-semibold rounded-2xl focus:ring-2 focus:ring-blue-500/50 transform transition-all duration-300 border-2 border-gray-100 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-none relative overflow-hidden"
              >
            ...
            <div className="flex justify-between items-center mt-8 pt-6 border-t border-white/10">
              <button className="flex items-center space-x-2 px-4 py-2 text-blue-400 hover:text-blue-300 transition-all duration-200 hover:bg-white/5 rounded-lg">
                ...
                <span className="text-sm" onClick={() => navigate("/my-urls")}>
                  My URLs
                </span>
              </button>
          ...
          <div className="mt-6 text-center">
            <p className="text-white/40 text-xs">Secure • Fast • Reliable</p>
          </div>
        </div>
      </div>
    </div>
