...
import { Copy, ExternalLink, Calendar, Link2, Sparkles, Loader2, AlertCircle, Globe } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-12 px-4">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <button className="text-gray-300 cursor-pointer px-3 py-1 mt-3 mb-6 border-2 border-gray-500 hover:border-gray-300 rounded-lg" onClick={() => navigate('/')}>
                ...
                {!loading && urls.length === 0 && !error && (
                    <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-12 text-center">
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <h3 className="text-2xl font-semibold text-gray-300 mb-4">No URLs yet</h3>
                            <p className="text-gray-400 max-w-md">
                                Start shortening your long URLs to see them appear here. Your shortened links will be beautifully organized and easy to manage.
                            </p>
                        </div>
                    </div>
                )}
                                        ...
                                        <div className="flex-1 space-y-4">
                                            ...
                                            <div className="flex items-start space-x-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-sm font-medium text-gray-300 mb-1">Original URL</p>
                                                    <a
                                            ...
                                            <div className="flex items-start space-x-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-sm font-medium text-gray-300 mb-1">Short URL</p>
                    ...
                    <div className="mt-12 text-center">
                        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl px-6 py-3 inline-block">
                            <p className="text-gray-300">
                                Total URLs: <span className="text-purple-400 font-semibold">{urls.length}</span>
                            </p>
                        </div>
                    </div>
                )}
